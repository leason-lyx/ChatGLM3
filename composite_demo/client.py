...
class Client(Protocol):
    def generate_stream(
            self, system: str | None, tools: list[dict] | None,
            history: list[Conversation],
            **parameters: Any) -> Iterable[TextGenerationStreamResponse]:
        ...
        ...
        for new_text, _ in stream_chat(
            ...
            yield TextGenerationStreamResponse(
                ...
                token=Token(
                    ...
                    logprob=0,
                    text=word,
                    special=word_stripped.startswith('<|')
                    and word_stripped.endswith('|>'),
                ))
